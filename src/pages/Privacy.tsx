    ...
    <Layout>
      <div className="pt-28 pb-14 px-6 max-w-3xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none text-muted-foreground space-y-6">
          ...
          <p>
            {brand.name} ("we," "our," or "us") is a Chrome extension and related service that helps users understand online articles. We collect information you provide directly to us, such as when you sign in, request support, or otherwise communicate with us.
          </p>

          <h2 className="text-2xl font-semibold text-foreground mt-6 mb-3">2. How We Use Your Information</h2>
          <p>
            We use the information we collect to provide, maintain, and improve the reading features you request, including article recommendations, explanations, rewrites, diagrams, and source-grounded answers.
          </p>
